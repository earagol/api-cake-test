...
class SitioUsuariosTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('SitioUsuarios') ? [] : ['className' => SitioUsuariosTable::class];
        $this->SitioUsuarios = TableRegistry::get('SitioUsuarios', $config);
    }
